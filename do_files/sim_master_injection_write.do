...
add wave -position insertpoint  \
sim:/tb_master_injection_write/u_TOP_MASTER/u_BACKEND_MASTER/u_BACKEND_MASTER_INJECTION/u_BACKEND_MASTER_PACKETIZER_CONTROL/r_CURRENT_STATE

add wave -position insertpoint  \
sim:/tb_master_injection_write/u_TOP_MASTER/u_BACKEND_MASTER/u_BACKEND_MASTER_INJECTION/u_BACKEND_MASTER_SEND_CONTROL/r_CURRENT_STATE
...
add wave -position insertpoint  \
sim:/tb_master_injection_write/u_TOP_MASTER/u_BACKEND_MASTER/u_BACKEND_MASTER_INJECTION/w_ARESET \
sim:/tb_master_injection_write/u_TOP_MASTER/u_BACKEND_MASTER/u_BACKEND_MASTER_INJECTION/w_FLIT \
sim:/tb_master_injection_write/u_TOP_MASTER/u_BACKEND_MASTER/u_BACKEND_MASTER_INJECTION/w_WRITE_BUFFER \
sim:/tb_master_injection_write/u_TOP_MASTER/u_BACKEND_MASTER/u_BACKEND_MASTER_INJECTION/w_WRITE_OK_BUFFER \
sim:/tb_master_injection_write/u_TOP_MASTER/u_BACKEND_MASTER/u_BACKEND_MASTER_INJECTION/w_READ_BUFFER \
sim:/tb_master_injection_write/u_TOP_MASTER/u_BACKEND_MASTER/u_BACKEND_MASTER_INJECTION/w_READ_OK_BUFFER

add wave -position insertpoint  \
sim:/tb_master_injection_write/u_TOP_MASTER/u_BACKEND_MASTER/u_BACKEND_MASTER_INJECTION/u_BUFFER_FIFO/fifo/shift/fifo_r
