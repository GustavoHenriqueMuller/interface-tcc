...
HD_PWD='/home/haas/Documents/Gihtub/InterfaceTCC/vivado/tcc.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log tcc_tb.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source tcc_tb.tcl
